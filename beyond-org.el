...
(setq beyond-org-mode-easy-bindings
      `((beyond-org-mode-refile-state-map
         ("m" (org-convenience-refile-convenience-next my/org-main-file nil) (propertize "Main" 'face '(:foreground "#0a0")))
         ("b" (org-convenience-refile-convenience-next org-default-notes-file "Notes") (propertize "Note" 'face '(:foreground "#0a0")))
         ("a" (org-convenience-refile-convenience-next my/org-always-file nil) "Always")
         ("r" (org-convenience-refile-convenience-next org-default-notes-file) "Reference")
				 ("z" (org-convenience-refile-convenience-next org-convenience-thoughts-file) "Thoughts")
         ("R" (org-convenience-refile-convenience-next org-default-notes-file "Recipes") "Recipes")
				 ("I" (org-convenience-refile-convenience-next my/org-inbox-file nil) "Inbox")
				 ("s" (org-convenience-refile-convenience-next my/org-someday-file) "Someday")
				 ("v" (org-convenience-refile-convenience-next my/org-appointments-file) "Events")
				 ("e" (org-convenience-refile-convenience-next my/org-eventually-file) "Eventually")
				 ("T" (org-convenience-refile-convenience-next my/org-tickler-file) "Tickle")
				 ("o" (org-convenience-refile-convenience-next my/org-read-file) "Read")
				 ("O" (org-convenience-refile-convenience-next org-convenience-reddit-notes-file) "Reddit")
				 ("E" (org-convenience-refile-convenience-next "emacs.org" "Someday") "Emacs")
				 ("H" (org-convenience-refile-convenience-next my/org-habits-file) "Habits")
